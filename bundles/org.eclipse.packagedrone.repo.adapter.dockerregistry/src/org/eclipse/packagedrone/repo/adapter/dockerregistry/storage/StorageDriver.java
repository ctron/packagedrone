 ...
 * This interface decouples the Docker Registry from the storage and allows to
 * plug in
...
public interface StorageDriver
{
     ...
     * @return InputStream Returns an InputStream for the specified file, if it
     *         is present.
     */
     ...
     * @param append
     *            Pass 'true' if the data needs to be appended to the specified
     *            file
     * @return FileWriter
     */
     ...
     *            Destination path of the source file
     ...
     *            Path of the file
     * @param options
     *            Optional set of options according to which the URL should be
     *            created
