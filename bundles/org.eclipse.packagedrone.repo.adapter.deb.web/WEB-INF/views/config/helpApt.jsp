...
&lt;distributionManagement&gt;
    &lt;repository&gt;
        ...
        &lt;url&gt;${sitePrefix }/apt/${channel.id }&lt;/url&gt;
    &lt;/repository&gt;
&lt;/distributionManagement&gt;
…</pre>
    </div>
...
<!-- <div>
    <pre>mvn deploy -DaltDeploymentRepository=pdrone.${channel.id }::default::${sitePrefix }/apt/${channel.id }</pre>
</div> -->
...
&lt;repositories&gt;
    &lt;repository&gt;
        &lt;id&gt;pdrone.${fn:escapeXml(channel.names) }&lt;/id&gt;
        &lt;url&gt;${sitePrefix }/apt/${web:encode(channel.names)}&lt;/url&gt;
    &lt;/repository&gt;
&lt;/repositories&gt;
…</pre>
    </div>
